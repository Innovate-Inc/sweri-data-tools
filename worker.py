...
aws_secret_key = safequote(os.environ.get('CELERY_BROKER_AWS_SECRET_ACCESS_KEY'))

broker_url = 'pyamqp://guest@rabbit:5672//'
if os.environ.get('CELERY_BROKER_AWS_ACCESS_KEY_ID') and os.environ.get('CELERY_BROKER_AWS_SECRET_ACCESS_KEY'):
