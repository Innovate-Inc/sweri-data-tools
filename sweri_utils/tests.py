...
class SqlTests(TestCase):
    ...
    def test_insert_from_db(self):
        ...
        expected_q = f'''INSERT INTO {schema}.{insert_table} (shape, {','.join(insert_fields)}) SELECT ST_MakeValid(ST_TRANSFORM(shape, 4326)), {','.join(from_fields)} FROM {schema}.{from_table};'''
        # Call the function
